...
def main():
    ...
    with mlflow.start_run(run_name=f"final_{args.model}"):
        ...
        if is_dl:
            ...
            model, y_val_pred, y_test_pred, metrics = \
                train_sklearn(args.model, best_params, cfg, data)
        ...
        log.info(f"Saving {args.model} model to MLflow...")
    ...
    print("  Artifacts (plots, model) are stored on S3.")
    print("="*65)
